                ...
                <div className={`${style.container} ${light ? style.container_light : ''}`}>
                    ...
                    <div className={style.me}>
                        ...
                        <div className={style.badges} style={(user?.status?.emote || user?.status?.text) ? { marginTop: 8 } : { marginTop: width > 540 ? 14 : 4 }}>
                            <button className={`${style.badge} ${light ? style.badge_light : ''}`} title='https://github.com/DolphinNotFound' onClick={() => window.open('https://github.com/DolphinNotFound')}> <HiOutlineFire style={{ height: 22, width: 22, marginRight: 4 }} /> UI&nbsp;Designer </button>
                            <button className={`${style.badge} ${light ? style.badge_light : ''}`} title='https://github.com/DolphinNotFound' onClick={() => window.open('https://github.com/DolphinNotFound')}> <HiOutlineCode style={{ height: 22, width: 22, marginRight: 4 }} /> Developer </button>
                        </div>
                    </div>
                    <div className={style.content}>
                        <div className={`${style.readme} ${light ? style.readme_light : ''}`}>
                            ...
                            <div style={{ marginTop: 8, marginLeft: 12, display: 'block' }}>
                                I'm <strong>Dolphin</strong>! <strong>I like coding discord bots and websites for fun!</strong> and currently live in <strong>Philadelphia</strong> near NJ.. Some of my hobbies are <strong>coding</strong> and <strong>excercising</strong>.
                                <img src='https://cdn.discordapp.com/emojis/750307298827567236.png?size=20&quality=lossless' style={{ position: 'relative', top: 5 }} draggable={false} /> hahahaha

                                <br />
                                <br />

                                I'm <strong>a goofy ahh cat</strong> and my pronouns are <strong>no/pronouns</strong> <img src='https://cdn.discordapp.com/emojis/959513603134853180.png?size=20&quality=lossless' style={{ position: 'relative', top: 3 }} draggable={false} />, in my free time I love to <strong>code and work on my Discord bots</strong> and websites! I'm a <strong>single discord bot and website developer</strong>. <img src='https://cdn.discordapp.com/emojis/959513603009028146.png?size=20&quality=lossless' style={{ position: 'relative', top: 3 }} draggable={false} />

                                <br />
                                <br />

                                I mainly work at my <strong>Discord Bot @DolphinNotBot and also my bot dashboard</strong> - a super advanced bot created for my server (DolphWorld!) <br />
                                My bot has<strong>a few moderation commands (ban,kick,timeout,autorole)</strong> and <strong>a economy system (The currency is called DolphinBucks and DolphCoins if your not fimiliar with them)</strong>. <br />
                                You can learn more about it at <button className='link' style={{ fontSize: '1.1rem' }} onClick={() => window.open('https://dolphinnotbotdashboard.vercel.app/')}>https://dolphinnotbotdashboard.vercel.app/ (still working on it)</button> <img src='https://cdn.discordapp.com/emojis/959513603097116763.png?size=20&quality=lossless' style={{ position: 'relative', top: 3 }} draggable={false} />
                            </div>
                            <br />
                            <strong style={{ fontSize: 27 }}>🪄 Languages I code in</strong><br />
                            <div style={{ marginTop: 8, marginLeft: 12 }}>
                                •&nbsp; JavaScript, Node.JS, Python<br />
                                •&nbsp; Next.JS, Express<br />
                                •&nbsp; HTML, CSS, TypeScript<br />
                                •&nbsp; MongoDB<br />
                            </div>
                            <br />
                            <strong style={{ fontSize: 27 }}>🍧 Contact Me!</strong><br />
                            <div style={{ marginTop: 8, marginLeft: 12 }}>
                                You want to collaborate with me or just want to have a nice talk in with my community? <br />
                                Feel free to join my <button className='link' style={{ fontSize: '1.1rem' }} onClick={() => window.open('https://discord.com/invite/K65AYbuDeF')}>Discord server (DolphWorld)</button> and shoot a ping at me!
                            </div>
